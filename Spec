  ...
  return (
    <div className="p-4">
      ...
      <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-6">
        {/* KPI Cards aqui */}
        <Card><CardContent>Ligações Efetuadas</CardContent></Card>
        <Card><CardContent>Ligações Atendidas</CardContent></Card>
        <Card><CardContent>Reuniões Marcadas</CardContent></Card>
        <Card><CardContent>Duração Total</CardContent></Card>
        <Card><CardContent>Duração Média</CardContent></Card>
        <Card><CardContent>Taxa de Atendimento</CardContent></Card>
      </section>
